...
${DOCKER_CLI} buildx build -f ../docker-compose/Dockerfile_interface --platform linux/${TARGET_ARCH} -t ${IMAGE_NAME2}:${IMAGE_TAG2} --output "type=docker,name=${IMAGE_NAME2}:${IMAGE_TAG2}" --build-context project=../  .
