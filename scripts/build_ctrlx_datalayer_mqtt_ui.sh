...
${DOCKER_CLI} buildx build -f ../docker-compose/Dockerfile_ui --platform linux/${TARGET_ARCH} -t ${IMAGE_NAME3}:${IMAGE_TAG3} --output "type=docker,name=${IMAGE_NAME3}:${IMAGE_TAG3}" --build-context project=../ .
